                    ...
                    <div className="mt-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <input
                                ...
                                value={
                                    nuevo.precio
                                        ? new Intl.NumberFormat("es-AR").format(nuevo.precio)
                                        : ""
                                }
                                onChange={(e) => {
                        ...
                        <div className="mb-4">
                            <textarea
                                className="w-full bg-slate-800 border border-slate-600 text-slate-100 placeholder-slate-400 px-3 py-2 rounded min-h-[80px] focus:outline-none focus:ring-2 focus:ring-emerald-500"
                                    ...
                                    >
                                        {editando?._id === i._id ? (
                                            ...
                                            <div className="flex-1 flex flex-col md:flex-row gap-2">
                                                <input
                                                    className="bg-slate-800 border border-slate-600 text-slate-100 px-2 py-1 rounded flex-1"
                                                ...
                                                />
                                                <textarea
                                                    className="bg-slate-800 border border-slate-600 text-slate-100 px-2 py-2 rounded flex-1 resize-y min-h-[40px] md:min-h-[60px]"
                                                ...
                                                />
                                                <input
                                                    className="bg-slate-800 border border-slate-600 text-slate-100 px-2 py-1 rounded w-full md:w-24 text-right"
                                                    type="text"
                                            ...
                                            <>
                                                <div className="flex-1">
                                                    <p
                                                        className={`font-bold ${!i.activo ? "opacity-50 line-through" : ""
                                                            }`}
                                                    >
                                                        {i.nombre}
                                                    </p>
                                                ...
                                                {/* Checkbox de ruleta solo para cócteles */}
