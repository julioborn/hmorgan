...
export default function AdminPedidosPage() {
    ...
    function abrirWhatsApp(p: any) {
        ...
        const partes: string[] = [
            MENSAJE_WA.replace("{nombre}", nombre),
            "",
            "Detalle del pedido:",
            lineasItems,
            "",
        ...
        <div className="p-6 min-h-screen text-white">
            ...
            <div className="flex justify-center items-center gap-3 mb-6">
                ...
                <button
                    ...
                    className={`relative flex h-6 w-10 shrink-0 cursor-pointer rounded-full items-center transition-colors duration-200 ${pedidosActivos ? "bg-red-500" : "bg-gray-300"}`}
                >
